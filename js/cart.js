...
const checkoutButton = document.querySelector(".checkout-button"); // Use class instead of ID to avoid conflicts
...
function attachCartEvents() {
    ...
    if (checkoutButton) {
        ...
        checkoutButton.removeEventListener("click", handleCheckout); // Remove existing listener to avoid duplicates
        checkoutButton.addEventListener("click", handleCheckout); // Add single listener
    }
}
